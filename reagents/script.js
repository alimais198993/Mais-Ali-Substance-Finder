...
function toggleLanguage() {
    ...
    document.getElementById("title").innerText = currentLang === "en" ? "Mais Ali Substance Finder" : "باحث المواد التحليلية";
...
function filterCategory(category) {
    if (category === "All") {
        ...
        filteredSubstances = substances.filter(function(s) { return s.category === category; });
    }
    renderCards(filteredSubstances);
}
